...
Objective
    ...
    To determine whether the average blood pressure (systolic and diastolic) in the sample significantly differs from the standard clinical values of 120/80 mmHg using a one-sample t-test.
    To assess whether diabetic individuals have significantly different blood pressure than non-diabetic individuals using a two-sample Welch’s t-test.
...
Methodology
    ...
    Data Import and Setup: The CSV file was loaded using pandas. Initial exploration included checking the structure and verifying data consistency.
    One-Sample t-Test: Applied to test if average systolic and diastolic pressures deviate from 120 and 80 mmHg, respectively.
    Two-Sample t-Test (Welch’s): Conducted to evaluate differences in blood pressure between diabetic and non-diabetic groups.
    Visualization: Graphs (bar plots with error bars) were generated to illustrate the distribution and test outcomes.
